...
public class Controller {
    ...
    public Controller() {
        ...
        this.cmdUtils.executeCommand("microservices-register", "docker run --network microservices-net -dp 1111:1111 microservices-register-image java -jar app.jar");
