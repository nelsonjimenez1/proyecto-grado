...
public class CreadorProyectoMicro {
    ...
    public CreadorProyectoMicro(String microName) {
        ...
        try {
            ...
            this.generador = new JavaGenerador();
    ...
    private void crearArchivoPorRuta(String ruta) {
        try {
    ...
    private void crearArchivos(ArrayList<String>listaRutas){
        for (String listaRuta : listaRutas) {
            this.crearArchivoPorRuta(listaRuta);
        }
    }
